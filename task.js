...
function display(){
    countTodo.innerHTML="To Do : "+ newTask.count("To Do");
    countProgress.innerHTML="In Progress : "+ newTask.count("In progress");
    countReview.innerHTML="Review : " + newTask.count("review");
    countDone.innerHTML="Done : " + newTask.count("Done");
    newTask.displayTask();
}
display();
...
displayDate.addEventListener("change",(e)=>{
    e.preventDefault();
    newTask.displayDateStatus(displayDate.value);
});
